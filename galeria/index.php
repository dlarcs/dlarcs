...
<head>
  ...
  <?php
   ...
   $cssFile = $base . '/galeria/style.css';
   $jsFile  = $base . '/galeria/app.js';
   ...
   <script defer src="../galeria/app.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
...
<body>
  ...
  <?php include "../galeria/menu/menu.php"; ?>

  <main class="container_portafolio">
    <?php include "../galeria/slider/slider.php" ?>
