  <?php $base = rtrim($_SERVER['DOCUMENT_ROOT'], '/');
...
<nav class="nav">
	<a href="https://dlarcs.com" class="nav__logo"> <img class="img_logo" src="global/navbar/img/logo_blanco.png" alt="">
		<h2 class="name_logo">D'LARCS</h2> </a>
	<div class="nav__links">
		<a href="#" class="nav__link"> <span class="nav__text">Inicio</span>
      <span class="nav__text nav__text--hover">Inicio</span>
    </a>
		<a href="#" class="nav__link"> <span class="nav__text">Productos</span>
      ...
      <span class="nav__text nav__text--hover">Portafolio</span>
		...
		<a href="#" class="nav__link"> <span class="nav__text">Proyectos</span>
      <span class="nav__text nav__text--hover">Proyectos</span>
    </a>
	</div>
	<div class="nav__actions"> <button class="nav__btn nav__btn--line">Contactanos</button>
		<!-- <button class="nav__btn nav__btn-fill">Get Started</button> --> </div>
	...
	<div id="navMenu" class="nav__mobile"> <a class="nav__mobile-link" href="#">Inicio</a>
